...
export default function Variation3() {
  return (
    <div className="min-h-screen">
      <nav className={`px-6 py-2 bg-[#021e25] text-white`}>
        ...
        <div className="container mx-auto px-6 py-12 lg:py-20 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center min-h-[80vh]">
            <div className="space-y-8">
              <div className="inline-flex items-center px-4 py-2 rounded-full border border-yellow-500 text-yellow-500 text-sm bg-white/90 backdrop-blur-sm">
              ...
              <p className="text-lg md:text-xl text-teal-50/90 leading-relaxed">
                A Māori-led platform uniting authenticity, wellbeing and ethical
                beauty — welcoming all cultures with open hearts.
              </p>

              <div className="flex flex-col sm:flex-row gap-4">
                <button className="px-8 py-4 bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-white font-semibold rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
                  I'm a Creator
                </button>
                <button className="px-8 py-4 border border-teal-400/50 hover:bg-gradient-to-r hover:from-teal-600/20 hover:to-emerald-600/20 hover:border-teal-300 text-teal-300 font-semibold rounded-lg transition-all duration-300 backdrop-blur-sm">
                  I'm a Brand
                </button>
              </div>
              <TrustIndicator />
            ...
            <div className="relative">
              {/* VeeVu Card */}
              <div className="absolute top-0 right-0 w-80 bg-gradient-to-br from-white/95 to-white/85 backdrop-blur-md rounded-2xl p-6 border border-white/20 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:-translate-y-2 hover:rotate-1 group">
              ...
              {/* iGlo Card */}
              <div className="absolute top-32 left-8 w-80 bg-gradient-to-br from-white/95 to-white/85 backdrop-blur-md rounded-2xl p-6 border border-white/20 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:-translate-y-2 hover:-rotate-1 group">
                <div className="flex items-start space-x-4">
              ...
              {/* Coming Soon Card */}
              <div className="absolute top-64 right-4 w-80 bg-gradient-to-br from-white/95 to-white/85 backdrop-blur-md rounded-2xl p-6 border border-white/20 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:-translate-y-2 hover:rotate-2 group">
                <div className="flex items-start space-x-4">
