  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 text-center text-white flex flex-col items-center pt-32">
        <div className="w-24 h-24 mb-32 rounded-full flex items-center justify-center overflow-hidden">
        ...
        >
          Truth in Beauty -
          <span className="relative whitespace-nowrap text-teal-400 dark:text-teal-400">
            <svg
              aria-hidden="true"
              viewBox="0 0 418 42"
              className="absolute top-2/3 left-0 h-[0.58em] w-full fill-teal-400/70 dark:fill-teal-300/60"
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <a
            href="#creator"
            className="px-6 py-3 bg-teal-600 hover:bg-teal-700 text-white text-lg font-semibold rounded-full shadow-lg transition-transform transform hover:scale-105"
          >
            I'm a Creator
          </a>
          <a
